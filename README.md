...
**The ultimate zero-friction online scratchpad.**

No signup, no login, and no hurdles. Built to be as simple as the Windows Notepad, but accessible from any device.
...
### ✨ Features
* **Instant Access:** No onboarding. Just type and go.
...
* **Encryption:** Note content is stored securely but is **not** end-to-end encrypted.
...
A. Yes! To allow others to view your note without being able to edit it, follow these steps:

1. Add a password to your note.
2. Click **Options** in the upper right corner.
3. Check the **Protected** box.
4. Check the **Public** box.

**Q. I forgot my note's password. How can I restore access to my note?**

A. For standalone notes, the password feature is designed to be as simple as possible. Because of this, **there is no way to recover or change a forgotten password**, so please keep it in a safe place!

> **Pro-Tip:** If you want to avoid losing access in the future, we recommend creating an account at [nopedat.web.app/account](https://nopedat.web.app/account/). Account access can always be restored via email, and logging in allows you to officially claim your notes.
